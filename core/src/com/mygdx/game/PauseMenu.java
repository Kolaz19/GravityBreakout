...
public class PauseMenu extends Stage {
    ...
    private AnimationActor pauseIcon;
    ...
    public PauseMenu(SpriteBatch batch, OrthographicCamera cam, int width, int height, StateManager manager) {
        ...
        pauseIcon = new AnimationActor(pauseIconAnimation, width / 2 - pauseIconAnimation.getKeyFrame(0).getRegionWidth() / 2, height / 2 - pauseIconAnimation.getKeyFrame(0).getRegionHeight() / 2);

        exitButton = new ButtonActor("exitButton.png", "exitButtonPressed.png", 5, 147) {
            @Override
